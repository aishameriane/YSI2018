...
6.  <span style="color:red">**Dúvida 6:** </span>
...
pacman::p_load(devtools, ggplot2, forecast, BETS, seasonal, seasonalview, bvarsv, lubridate, zoo, stargazer, gridExtra, reshape2, ggfortify, RColorBrewer, scales, quantmod, PerformanceAnalytics, strucchange, coda, foreach, doParallel, knitr, grid, ggpubr, gdata, vars, urca, compiler) 
```
...
pdf(file = "D:\\Onedrive - Aisha\\OneDrive\\Documentos\\Mestrado Economia\\Dissertação\\YSI - Buenos Aires\\Figuras\\FIR\\Fig_brooks.pdf", width = 6, height = 3)
p2
dev.off()
...
Fiz previsão 1, 6, 12, e 24 passos à frente.


## 1 passo à frente

Posso usar o que eu já tinha estimado.
...
Vou deixar isso aqui de lado por enquanto

```{r, echo = FALSE, eval = FALSE}
# Variável para fazer a previsão
sel.var <- 1 # 1- Razão capital trabalho 2 - ipca 3 - pib 4 - swap 5 - cambio

# Ajusta um outro var apenas para comparar, estimado por MQO
